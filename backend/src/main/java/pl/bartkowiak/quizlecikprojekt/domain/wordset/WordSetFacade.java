...
import static pl.bartkowiak.quizlecikprojekt.domain.wordset.WordSetMapper.mapToWordSetResponse;

import pl.bartkowiak.quizlecikprojekt.controllers.dto.word.WordResponse;
import pl.bartkowiak.quizlecikprojekt.controllers.dto.wordset.WordSetCreateRequest;
import pl.bartkowiak.quizlecikprojekt.controllers.dto.wordset.WordSetResponse;
import pl.bartkowiak.quizlecikprojekt.controllers.dto.wordset.WordSetUpdateRequest;
import pl.bartkowiak.quizlecikprojekt.controllers.dto.wordset.WordUpdateRequest;
...
import pl.bartkowiak.quizlecikprojekt.domain.wordset.dto.WordAddRequest;
import pl.bartkowiak.quizlecikprojekt.domain.wordset.dto.WordAddResponse;
...
public class WordSetFacade {
  ...
  public WordSetResponse createNewWordSet(String userEmail, WordSetCreateRequest request) {
    ...
    return WordSetMapper.mapToWordSetResponse(created);
  }
  ...
  public WordSetResponse updateWordSet(
    ...
    return WordSetMapper.mapToWordSetResponse(updatedWordSet);
  }
  ...
  public WordResponse updateWord(
    ...
    return WordSetMapper.mapToWordResponse(updatedWord);
  }
