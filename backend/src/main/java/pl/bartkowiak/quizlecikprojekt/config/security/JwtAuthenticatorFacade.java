...
import pl.bartkowiak.quizlecikprojekt.domain.user.UserRepository;
...
public class JwtAuthenticatorFacade {
  ...
  public JwtResponseDto authenticateAndGenerateToken(TokenRequestDto tokenRequest) {
    ...
    pl.bartkowiak.quizlecikprojekt.entity.User domainUser = userRepository.getUserByEmail(principal.getUsername())
