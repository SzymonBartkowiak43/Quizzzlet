...
public class ProgressController {
    ...
    public ResponseEntity<EvaluationResponse> evaluateResource(
            @Valid @RequestBody EvaluateResourceRequest request,
            Authentication authentication) {
    ...
    public ResponseEntity<ResourceEvaluationSummary> getVideoEvaluations(
    ...
    public ResponseEntity<EvaluationResponse> getMyWordSetEvaluation(
        ...
        User user = userService.getUserByEmail(authentication.getName());
        Optional<ResourceEvaluation> evaluation = evaluationService
                .getUserEvaluationForWordSet(user, wordSetId);
