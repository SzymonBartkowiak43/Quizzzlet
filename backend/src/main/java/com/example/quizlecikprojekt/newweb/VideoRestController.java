...
//        return ResponseEntity.badRequest().body(ApiResponse.error("Search query cannot be
// empty"));
//      }
//
...
//
//      logger.info(
//          "Video search performed by user: {} for query: '{}'", authentication.getName(), query);
...
//    } catch (Exception e) {
//      logger.error(
//          "Error adding comment to video: {} by user: {}",
//          id,
//          authentication != null ? authentication.getName() : "unknown",
//          e);
//      return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
...
//      boolean isAdmin = currentUser.roles().stream().anyMatch(role ->
...
//    } catch (Exception e) {
//      logger.error(
//          "Error deleting comment {} from video {} by user: {}",
//          commentId,
//          videoId,
//          authentication != null ? authentication.getName() : "unknown",
//          e);
...
//    return new CommentResponse(
//        comment.getId(), comment.getContent(), comment.getUser().getName(),
