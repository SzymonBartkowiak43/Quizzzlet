...
public class ResourceEvaluation {
    ...
    public Integer getCompletionTimeMinutes() { return completionTimeMinutes; }
    public void setCompletionTimeMinutes(Integer completionTimeMinutes) { this.completionTimeMinutes = completionTimeMinutes; }
