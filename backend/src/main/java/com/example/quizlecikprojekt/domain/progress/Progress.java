...
public class Progress {
    ...
    public WordSet getWordSet() { return wordSet; }
    public void setWordSet(WordSet wordSet) { this.wordSet = wordSet; }

    public LocalDate getStudyDate() { return studyDate; }
    public void setStudyDate(LocalDate studyDate) { this.studyDate = studyDate; }

    public Integer getTotalWordsStudied() { return totalWordsStudied; }
    public void setTotalWordsStudied(Integer totalWordsStudied) { this.totalWordsStudied = totalWordsStudied; }
    ...
    public Integer getFlashcardsCompleted() { return flashcardsCompleted; }
    public void setFlashcardsCompleted(Integer flashcardsCompleted) { this.flashcardsCompleted = flashcardsCompleted; }
